...
public class YamlChangeLogParser_RealFile_Test extends Specification {
    ...
    def "tests for particular features and edge conditions part 3 testCasesChangeLog.yaml"() throws Exception {
        ...
        //TODO engine: new ISODateFormat().format(new java.sql.Timestamp(((AddColumnChange) changeLog.getChangeSet(path, "nvoxland", "different object types for column").changes[1]).columns[4].defaultValueDate.time)).matches(/2014-12-\d+T\d+:15:33/) //timezones shift actual value around
        //
